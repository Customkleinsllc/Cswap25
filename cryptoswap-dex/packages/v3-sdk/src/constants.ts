...
export const FACTORY_ADDRESSES = {
  ...
  [ChainId.POLYGON]: '0x1F98431c8aD98523631AE4a59f267346ea31F984', // Uniswap V3 Factory on Polygon
  [ChainId.AVALANCHE]: '0x740b1c1de25031C31FF4fC9A62f554A55cdC1baD', // Placeholder for Avalanche
  [ChainId.AVALANCHE_FUJI]: '0x740b1c1de25031C31FF4fC9A62f554A55cdC1baD', // Placeholder for Fuji
  [ChainId.SEI]: '0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865', // Placeholder for SEI
...
export const DEPLOYER_ADDRESSES = {
  ...
  [ChainId.AVALANCHE_FUJI]: DEPLOYER_ADDRESS,
  [ChainId.SEI]: DEPLOYER_ADDRESS,
} as const satisfies Record<ChainId, Address>
...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.AVALANCHE_FUJI]: POOL_INIT_CODE_HASH,
  [ChainId.SEI]: POOL_INIT_CODE_HASH,
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.POLYGON]: '0xC36442b4a4522E871399CD717aBDD847Ab11FE88', // Uniswap V3 Position Manager on Polygon
  [ChainId.AVALANCHE]: NFT_POSITION_MANAGER_ADDRESS,
  [ChainId.AVALANCHE_FUJI]: NFT_POSITION_MANAGER_ADDRESS,
  [ChainId.SEI]: NFT_POSITION_MANAGER_ADDRESS,
} as const satisfies Record<ChainId, Address>
