import { Currency, CurrencyAmount, Pair, ZERO } from '@CryptoSwap/sdk'
import { Pool as V3Pool, TickList } from '@CryptoSwap/v3-sdk'
import { getQuoteExactIn, getQuoteExactOut } from '@CryptoSwap/stable-swap-sdk'
import {
  Pool as IPool,
  Pool,
  QuoteProvider,
