...
export const Chains: Chain[] = [
  ...
  { id: ChainId.POLYGON, name: chainNames[ChainId.POLYGON], fullName: chainFullNames[ChainId.POLYGON], isEVM: true },
  { id: ChainId.AVALANCHE, name: chainNames[ChainId.AVALANCHE], fullName: chainFullNames[ChainId.AVALANCHE], isEVM: true },
  { id: ChainId.SEI, name: chainNames[ChainId.SEI], fullName: chainFullNames[ChainId.SEI], isEVM: true },
  {
  ...
  { id: ChainId.SEPOLIA, name: chainNames[ChainId.SEPOLIA], fullName: chainFullNames[ChainId.SEPOLIA], isEVM: true },
  {
    ...
    name: chainNames[ChainId.AVALANCHE_FUJI],
    fullName: chainFullNames[ChainId.AVALANCHE_FUJI],
    isEVM: true,
    testnet: true,
  },
  {
