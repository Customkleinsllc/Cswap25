import { Currency, CurrencyAmount, ERC20Token, Native, Pair, TradeType, Trade as V2Trade } from '@CryptoSwap/sdk'
import {
  Pool as GenericPool,
  InfinityBinPool,
  InfinityClPool,
...
import { Pool, Trade as V3Trade } from '@CryptoSwap/v3-sdk'
