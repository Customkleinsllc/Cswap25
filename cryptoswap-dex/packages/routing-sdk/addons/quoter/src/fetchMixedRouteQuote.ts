...
import { StablePool, isStablePool } from '@CryptoSwap/routing-sdk-addon-stable-swap'
import { V2Pool, isV2Pool } from '@CryptoSwap/routing-sdk-addon-v2'
import { V3Pool, isV3Pool } from '@CryptoSwap/routing-sdk-addon-v3'
