...
import { Percent, TradeType } from '@CryptoSwap/sdk'
import { InfinityRouter, SmartRouterTrade } from '@CryptoSwap/smart-router'
...
import { BridgeTrade } from '@CryptoSwap/price-api-sdk'
