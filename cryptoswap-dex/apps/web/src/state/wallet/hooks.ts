import { ChainId, Currency, CurrencyAmount, Native, Token, UnifiedCurrency, ZERO_ADDRESS } from '@CryptoSwap/sdk'
import { useQuery } from '@tanstack/react-query'
import { isSolana, NonEVMChainId } from '@CryptoSwap/chains'
import { selectedEvmWalletAtom, selectedSolanaWalletAtom } from '@CryptoSwap/ui-wallets/src/state/atom'
import useAccountActiveChain from 'hooks/useAccountActiveChain'
import { useLocalStorage, useWallet } from '@solana/wallet-adapter-react'
import { EvmConnectorNames, SolanaProviderLocalStorageKey, WalletAdaptedNetwork } from '@CryptoSwap/ui-wallets'
...
import { useSelectedWallet } from '@CryptoSwap/ui-wallets/src/state/hooks'
