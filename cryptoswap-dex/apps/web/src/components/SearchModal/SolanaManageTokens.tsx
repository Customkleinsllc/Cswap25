...
import { SPLToken } from '@CryptoSwap/swap-sdk-core'
import type { TokenInfo } from '@CryptoSwap/solana-core-sdk'
import {
  AutoColumn,
  BscScanIcon,
  Button,
...
import { CheckIcon, CurrencyLogo } from '@CryptoSwap/widgets-internal'
