import { Box, CopyButton, Flex, FlexProps, Image, Text, WalletFilledV2Icon } from '@CryptoSwap/uikit'
...
import { legacyPreviouslyUsedWalletsAtom } from '@CryptoSwap/ui-wallets'
