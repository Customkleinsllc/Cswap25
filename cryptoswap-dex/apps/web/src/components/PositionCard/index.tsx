...
import { Currency, CurrencyAmount, Pair, Percent } from '@CryptoSwap/sdk'
import { Text, Card, CardBody, Flex, CardProps, TooltipText, useTooltip, Link, AutoColumn } from '@CryptoSwap/uikit'
