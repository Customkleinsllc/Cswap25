import { useTranslation, TranslateFunction } from '@CryptoSwap/localization'
import { styled } from 'styled-components'
import { Card, Flex, Box, InfoIcon, Text, useTooltip } from '@CryptoSwap/uikit'
...
import { AVERAGE_CHAIN_BLOCK_TIMES, ChainId, chainNames, getChainName } from '@CryptoSwap/chains'
