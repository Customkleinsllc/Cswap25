import { ChainId, Currency, CurrencyAmount, ERC20Token } from '@CryptoSwap/sdk'
import { DAI, USDC, USDT } from '@CryptoSwap/tokens'
import { parseNumberToFraction } from '@CryptoSwap/utils/formatFractions'
