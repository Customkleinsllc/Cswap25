...
import { Currency, CurrencyAmount, Token } from '@CryptoSwap/swap-sdk-core'
import { FeeTier, FlexGap, Row, Skeleton, Tag, Text, useMatchBreakpoints } from '@CryptoSwap/uikit'
import { formatNumber as formatBalance } from '@CryptoSwap/utils/formatBalance'
import { formatNumber } from '@CryptoSwap/utils/formatNumber'
import { DoubleCurrencyLogo, FiatNumberDisplay } from '@CryptoSwap/widgets-internal'
