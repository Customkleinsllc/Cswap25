...
import { Currency, CurrencyAmount, Price, Token } from '@CryptoSwap/swap-sdk-core'
import { PairDataTimeWindowEnum, UseModalV2Props } from '@CryptoSwap/uikit'
import { encodeSqrtRatioX96, parseProtocolFees, TickMath } from '@CryptoSwap/v3-sdk'
import { RoiCalculatorModalV2 } from '@CryptoSwap/widgets-internal/roi'
