...
export const DEFAULT_META: PageMeta = {
  title: 'CryptoSwap',
  description: 'Best prices across all DEXes - Trade, earn, and maximize your yields with our DeFi aggregator',
  ...
  return {
    paths: {
      ...
      '/info': {
        ...
        description: 'View statistics for CryptoSwap aggregated exchanges.',
      ...
      '/liquidity/pool': {
        basePath: true,
        title: `${t('Pool Detail')}`,
        description: 'View statistics for CryptoSwap aggregated pools.',
        image: `${ASSET_CDN}/web/og/info.jpg`,
      },
    ...
    defaultTitleSuffix: t('CryptoSwap'),
  }
})
