import { ChainId, STABLESWAP_SUBGRAPHS, V2_SUBGRAPHS, V3_SUBGRAPHS } from '@CryptoSwap/chains'
...
export const ASSET_CDN = process.env.NEXT_PUBLIC_ASSET_CDN || 'https://assets.cryptoswap.com'
