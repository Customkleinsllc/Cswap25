...
import { chainlinkOracleCAKE } from '@CryptoSwap/prediction'
import { CurrencyParams, getCurrencyUsdPrice } from '@CryptoSwap/price-api-sdk'
import { Native } from '@CryptoSwap/sdk'
import { OnChainProvider, PoolType, SmartRouter, SmartRouterTrade } from '@CryptoSwap/smart-router'
import { Currency, CurrencyAmount, getCurrencyAddress, TradeType } from '@CryptoSwap/swap-sdk-core'
import { CAKE, STABLE_COIN } from '@CryptoSwap/tokens'
