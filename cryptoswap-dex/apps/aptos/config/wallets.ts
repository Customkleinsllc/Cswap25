...
export const wallets: LegacyWalletConfig<ConnectorNames>[] = [
  ...
  },
  {
    ...
    title: 'Trust Wallet',
    icon: 'https://cryptoswap.com/images/wallets/trust.png',
    get installed() {
      return typeof window !== 'undefined' && Boolean(window.aptos) && Boolean((window.aptos as any)?.isTrust)
    },
    deepLink: 'https://link.trustwallet.com/open_url?coin_id=637&url=https://aptos.cryptoswap.com/',
    connectorId: ConnectorNames.TrustWallet,
  },
  {
    id: LegacyWalletIds.SafePal,
    title: 'SafePal',
    icon: 'https://cryptoswap.com/images/wallets/safepal.png',
    get installed() {
