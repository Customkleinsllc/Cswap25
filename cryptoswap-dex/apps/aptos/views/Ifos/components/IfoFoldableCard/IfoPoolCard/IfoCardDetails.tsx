...
import { Box, Flex, IfoSkeletonCardDetails, Skeleton, Text, TooltipText, useTooltip } from '@CryptoSwap/uikit'
import { formatNumber, getBalanceNumber } from '@CryptoSwap/utils/formatBalance'
import { DAY_IN_SECONDS } from '@CryptoSwap/utils/getTimePeriods'
