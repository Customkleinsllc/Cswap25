...
import { Menu as UIMenu } from '@CryptoSwap/uikit'
import { NextLinkFromReactRouter } from '@CryptoSwap/widgets-internal'

import { usePhishingBanner } from '@CryptoSwap/utils/user'
    ...
    <>
      {isClient ? (
        <UIMenu
          ...
          buyCakeLink="https://aptos.CryptoSwap.finance/swap?outputCurrency=0x159df6b7689437016108a019fd5bef736bac692b6d4a1f10c941f6fbb9a74ca6::oft::CakeOFT"
          {...props}
        />
      ) : undefined}
    </>
