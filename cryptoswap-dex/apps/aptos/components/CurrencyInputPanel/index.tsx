...
import { Currency, CurrencyAmount, Percent } from '@CryptoSwap/aptos-swap-sdk'
import { useAccount, useBalance } from '@CryptoSwap/awgmi'
import { useIsMounted } from '@CryptoSwap/hooks'
import { useCurrencyBalance } from 'hooks/Balances'
import useStablePrice from 'hooks/useStablePrice'
import { multiplyPriceByAmount } from 'utils/prices'
import { useTranslation } from '@CryptoSwap/localization'
import { AtomBox, Button, ChevronDownIcon, CopyButton, Text, useModal } from '@CryptoSwap/uikit'
