...
import { LegacyWalletConfig, LegacyWalletModal, LegacyWalletModalProps } from '@CryptoSwap/ui-wallets'
import { Button, type ButtonProps } from '@CryptoSwap/uikit'
  ...
  return (
    <>
      ...
      <LegacyWalletModal
        ...
        docLink="https://docs.CryptoSwap.finance/get-started-aptos/wallet-guide"
        isOpen={open}
