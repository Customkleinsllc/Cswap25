import { ChainId, Currency, Token } from '@CryptoSwap/aptos-swap-sdk'
import { APTOS_COIN } from '@CryptoSwap/awgmi'
import { useHttpLocations } from '@CryptoSwap/hooks'
import { WrappedTokenInfo } from '@CryptoSwap/token-lists'
import { TokenLogo } from '@CryptoSwap/uikit'
...
const getTokenLogoURL = memoize(
  (token?: Token) => {
    if (token && token.chainId === ChainId.MAINNET) {
      return `https://tokens.CryptoSwap.finance/images/aptos/${token.address}.png` // hex encoding
    }
    return null
  },
...
const APT_SRCS = ['https://tokens.CryptoSwap.finance/images/symbol/apt.png']
