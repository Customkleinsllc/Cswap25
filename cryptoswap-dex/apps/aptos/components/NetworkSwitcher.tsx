import { ChainId } from '@CryptoSwap/aptos-swap-sdk'
import { useNetwork } from '@CryptoSwap/awgmi'
import { useIsMounted } from '@CryptoSwap/hooks'
import { useTranslation } from '@CryptoSwap/localization'
import { Box, Text, UserMenu, UserMenuDivider, UserMenuItem } from '@CryptoSwap/uikit'
...
export const NetworkSwitcher = () => {
  ...
  return (
    <UserMenu
      mr="8px"
      variant="default"
      avatarSrc="https://tokens.cryptoswap.com/images/symbol/apt.png"
