...
import { Box, Flex, useMatchBreakpoints } from '@CryptoSwap/uikit'
import {
  BackgroundGraphic,
  BannerContainer,
  BannerDesc,
...
const learnMoreLink =
  'https://blog.CryptoSwap.finance/articles/step-by-step-guide-farming-liquidity-provisioning-and-bridging-on-aptos?utm_source=AptosFarm&utm_medium=Website&utm_campaign=Farm&utm_id=AptosFarmPage'
        ...
        title={
          <BannerTitle variant="purple">
            {isMobile || isTablet
              ...
              : t('Earn Dual Incentives with Yield Farming on Aptos CryptoSwap')}
          </BannerTitle>
        }
