import { GameType, PostersItemData, PostersLayout } from '@CryptoSwap/games'
import { useTranslation } from '@CryptoSwap/localization'
import { Box, Button, Card, CardHeader, Flex, Link, TelegramIcon, Text, useMatchBreakpoints } from '@CryptoSwap/uikit'
